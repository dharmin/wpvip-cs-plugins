<?php
/**
 * Anti-Mangler Filters.
 * 
 * @package anti-mangler-filters.
 */
...
/**
 * Wistia insert embeds for editor.
 * 
 * @param string $text Text.
 */
...
/**
 * Wistia add scripts if necessary.
 * 
 * @param string $text Text.
 */
